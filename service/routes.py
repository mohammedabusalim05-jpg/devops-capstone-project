...
def get_account(account_id):
    """Reads an Account"""
    app.logger.info("Request to read an Account: %s", account_id)
...
def update_account(account_id):
    """Updates an Account"""
    app.logger.info("Request to update an Account: %s", account_id)
...
def delete_account(account_id):
    """Deletes an Account"""
    app.logger.info("Request to delete an Account: %s", account_id)
